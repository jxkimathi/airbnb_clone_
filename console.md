...
You should have an `AUTHORS` file at the root of your repository, listing all individuals having contributed content to the repository. For format, reference Docker’s `AUTHORS` page. You should use branches and pull requests on GitHub - it will help you as a team to organize your work.
...
Update `FileStorage` to manage correctly serialization and deserialization of all those new classes.
...
my_place.description = "My house is beautiful"
...
- GitHub repository: `AirBnB_clone`
- File: `models/state.py`, `models/city.py`, `models/amenity.py`, `models/place.py`, `models/review.py`, `models/engine/file_storage.py`, `console.py`, `tests/`
...
Write all unittests for `console.py`, covering all features!

For testing the console, you should “intercept” STDOUT. We highly recommend using:
